...
class Visualization:
    ...
    def trajectory(self):
        ...
        # analytical solution:
        ax.plot(self.dt.xa_track, self.dt.t,  linestyle="-", color="red", label="continuum")
        ax.plot(self.dt.xn_track, self.dt.t, marker="x", linestyle="--", color="blue", label="Euler's method")
    ...
    def v_from_p_function(self):
        ...
        ax.plot(self.dt.momentum_t, track_c, linestyle=":",linewidth = 1,
        ...
        ax.plot(self.dt.momentum_t, self.dt.vel_anl, linestyle="-", color="red",
